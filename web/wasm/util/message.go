...
var (
	allMessages = map[string]map[int]string{
		...
		Spanish: {
			app:                          "DummyAI",
			cameraErrorNotAllowedText:    "Habilite el acceso a la cámara en la configuración de su dispositivo",
			cameraErrorNotAllowedTitle:   "Cámara no permitida",
			cameraErrorNotFoundText:      "Verifique que su cámara esté conectada y habilitada",
		...
		Portuguese: {
			app:                          "DummyAI",
			cameraErrorNotAllowedText:    "Habilite o acesso à câmera nas configurações do seu dispositivo",
			cameraErrorNotAllowedTitle:   "Câmera não permitida",
			cameraErrorNotFoundText:      "Verifique se sua câmera está conectada e habilitada",
